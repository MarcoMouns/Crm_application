...
//
//     final dataModelTamamlananProjeTipi = dataModelTamamlananProjeTipiFromJson(jsonString);
...
class DataModelTamamlananProjeTipi {
  ...
  factory DataModelTamamlananProjeTipi.fromRawJson(String str) => DataModelTamamlananProjeTipi.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DataModelTamamlananProjeTipi.fromJson(Map<String, dynamic> json) => DataModelTamamlananProjeTipi(
    draw: json["draw"],
...
enum ProjeSorumlusu { BURAK_EMUCE, ILKER_TIRYAKIOLU, BURAK_NASR, EMPTY, IREM_ERDOAN, UFUK_EN, KULLANC }
